...
In the Streamlit GUI, click the **Share** button on any finished summary. The app instantly publishes the Markdown to [Tinypaste](https://tnypst.xyz) and copies the returned short URL to your clipboard.

No account. No token. No friction.

## What the Shared Link Looks Like

The published page renders your summary as clean, readable Markdown with full support for:
...
You can also publish directly from the terminal or from agent workflows:
