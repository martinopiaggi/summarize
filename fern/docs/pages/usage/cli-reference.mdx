...
| `--speed` | Playback speed for audio preprocessing or visual-mode video. Reduces Groq cost (priced by duration) but may reduce accuracy. Any positive value. | `2.0` (from `summarizer.yaml`; code fallback `1.0`) |
