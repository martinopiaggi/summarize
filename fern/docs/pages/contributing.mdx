...
4. Update docs if install paths or user-facing behavior changes
5. Describe what you tested in the PR body

See also [CONTRIBUTING.md](https://github.com/martinopiaggi/summarize/blob/main/CONTRIBUTING.md) on GitHub.